...
const WORD_OPERATORS = new Set([
  // question phrasing
  'what', 'whats', 'how', 'much', 'is', 'calculate',
  // spelled-out arithmetic
  'plus', 'minus', 'times', 'multiplied', 'divided', 'by', 'remainder',
  'square', 'cube', 'root', 'power', 'the', 'mod',
  // conversion and rates
  'to', 'in', 'as', 'into', 'per', 'of', 'through', 'until',
  // percentages and multipliers
  'percent', 'percentage', 'off', 'on', 'added', 'and', 'or',
  'x', 'multiplier', 'multiple', 'fraction',
  // rounding and notation
  'rounded', 'nearest', 'up', 'down', 'dp', 'decimal', 'decimals', 'places',
  'digits', 'sig', 'significant', 'figs', 'figures', 'full', 'plain',
  'unabbreviated', 'sci', 'scientific', 'notation', 'number', 'dec',
  // statistics, which are also line directives
  'sum', 'total', 'subtotal', 'average', 'avg', 'mean', 'count', 'median',
]);
