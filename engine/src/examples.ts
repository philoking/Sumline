...
export const EXAMPLE_GROUPS: ExampleGroup[] = [
  ...
  },
  {
    ...
    examples: [
      ...
      { input: 'exp(1)', expected: '2.7182818285' },
      ...
      { input: 'e', expected: '2.7182818285' },
      { input: 'tau', expected: '6.2831853072' },
      { input: 'phi', expected: '1.6180339887' },
    ],
  },
  {
    id: 'trigonometry',
    ...
    examples: [
      ...
      { input: 'asin(0.5)', expected: '0.5235987756' },
      { input: 'atan2(1, 1)', expected: '0.7853981634' },
      { input: '45 deg in rad', expected: '0.7853981634 rad' },
      { input: '90 deg to rad', expected: '1.5707963268 rad' },
    ],
  },
  {
    id: 'bases',
  ...
  },
  {
    ...
    examples: [
      { input: '5 km in miles', expected: '3.1068559612 miles' },
      { input: '100 cm to m', expected: '1 m' },
      { input: '180 lbs in kg', expected: '81.6466266 kg' },
      ...
      { input: '72 F in C', expected: '22.2222222222 °C' },
